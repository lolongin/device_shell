...
plugins import them through this public module instead of depending on ``src``.
"""

from src._sample_data import STATUS_IDLE, STATUS_OCCUPIED, STATUS_OTHER, STATUS_PIPELINE
